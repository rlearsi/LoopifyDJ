...
public class CircleView extends BaseCircleView {
    ...
    protected void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, com.rlearsi.app.library.colorpicker.R.styleable.CircleView, defStyle, 0);

        // get main color
        setColor(attributes.getColor(com.rlearsi.app.library.colorpicker.R.styleable.CircleView_cv_color, Color.TRANSPARENT));
        setSelectColor(attributes.getColor(com.rlearsi.app.library.colorpicker.R.styleable.CircleView_cv_selectColor, Color.TRANSPARENT));
