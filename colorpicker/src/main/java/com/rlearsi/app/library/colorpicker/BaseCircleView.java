...
public class BaseCircleView extends View {
    ...
    public BaseCircleView(Context context) {
        this(context, null, com.rlearsi.app.library.colorpicker.R.styleable.CircleViewStyle_circleViewDefault);
    }

    public BaseCircleView(Context context, AttributeSet attrs) {
        this(context, attrs, com.rlearsi.app.library.colorpicker.R.styleable.CircleViewStyle_circleViewDefault);
    }
    ...
    protected void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView, defStyle, 0);

        // radius
        mFillRadius = attributes.getDimensionPixelOffset(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_fillRadius, DEFAULT_FILL_RADIUS);
        mIsRadiusSetByUser = mFillRadius != DEFAULT_FILL_RADIUS;

        // Check for extra features being enabled
        setHasBorder(attributes.getBoolean(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_border, false));

        setIsSelectable(attributes.getBoolean(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_selectable, false));
        // Set border properties, if enabled
        //if(mHasBorder) {
        setBorderWidth(attributes.getDimensionPixelOffset(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_borderWidth, 0));
        setBorderColor(attributes.getColor(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_borderColor, Color.TRANSPARENT));
        //}

        // Set select properties, if enabled
        //if(mIsSelectable) {
        setSelectBorderWidth(attributes.getDimensionPixelOffset(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_selectBorderWidth, 0));
        setSelectBorderColor(attributes.getColor(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_selectBorderColor, Color.TRANSPARENT));
        //}

        setFillColor(attributes.getColor(com.rlearsi.app.library.colorpicker.R.styleable.BaseCircleView_cv_fillColor, Color.TRANSPARENT));
